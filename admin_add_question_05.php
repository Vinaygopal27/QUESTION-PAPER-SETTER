...
$qrys=mysqli_query($connect,"insert into question_02 values('$id1','$degree','$dept','$year','$semester','$subjectcode','$subjectname','$unit','$select','$qstn','$a1','$a2','$a3','$a4','0','0')");
if($qrys==1)
{
?>					
					<script language="javascript">
					alert("Add Successfully");
					window.location.href="admin_add_question_05.php";
					</script>
					<?php
}
else
                            ...
                            <tr>
                              ...
                              <td width="69%"><table width="393" height="530" border="0" align="center">
                                ...
                                <tr>
                                  <td>Question</td>
                                  <td><label>
                                    <input name="qstn" type="text" id="qstn" required="">
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>Answer 1 </td>
                                  <td><label>
                                    <input name="a1" type="text" id="a1" required="">
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>Answer 2 </td>
                                  <td><label>
                                    <input name="a2" type="text" id="a2" required="">
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>Answer 3 </td>
                                  <td><label>
                                    <input name="a3" type="text" id="a3" required="">
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>Answer 4 </td>
                                  <td><label>
                                    <input name="a4" type="text" id="a4" required="">
                                  </label></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;	</td>
