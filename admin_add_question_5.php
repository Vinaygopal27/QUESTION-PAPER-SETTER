...
$max_qry = mysqli_query($connect,"select max(id) from  question_5");
...
$qrys=mysqli_query($connect,"insert into question_5 values('$id1','$degree','$dept','$year','$semester','$subjectcode','$subjectname','$unit','$select','$qstn','0','0')");
if($qrys==1)
{
?>					
					<script language="javascript">
					alert("Add Successfully");
					window.location.href="admin_add_question_5.php";
					</script>
					<?php
}
else
