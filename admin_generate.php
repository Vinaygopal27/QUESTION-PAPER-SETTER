...
if($select=="Internal 1")
{
header("Location:admin_generate_unit1.php");

}
else if($select=="Internal 2")
{
 
header("Location:admin_generate_unit2.php");
}
else if($select=="Semester")
{
header("Location:admin_generate_semester.php"); 
}
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h1>Question paper Set </h1>
						<form name="form1" method="post" action="">
						  <table width="100%" border="0" align="center">
                            <tr>
                              <td width="31%">&nbsp;</td>
                              <td width="69%"><table width="393" height="318" border="0" align="center">
                                <tr>
