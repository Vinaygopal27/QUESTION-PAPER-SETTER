...
if($select=="0.5")
{
header("Location:admin_add_question_05.php");

}
else if($select=="2")
{
header("Location:admin_add_question_2.php");


}
else if($select=="5")
{
header("Location:admin_add_question_5.php");

}
else if($select=="10")
{
header("Location:admin_add_question_10.php");
